// ============================================================
// Testbench : tb_fft8_sdf_csd
// DUT       : fft8_sdf_csd_top (SDF + CSD, no bit inversion)
//
// Compile:
//   iverilog -o sim \
//     fft8_sdf_csd_top.v stage1_sdf_csd.v \
//     stage2_sdf_csd.v   stage3_sdf_csd.v \
//     tb_fft8_sdf_csd.v && vvp sim
// ============================================================
`timescale 1ns/1ps
module tb_fft8_sdf_csd;
    ...
    initial begin
        ...
        $display("=========================================");
        $display("  FFT8 SDF + CSD (Optimized) TB");
        $display("=========================================");
