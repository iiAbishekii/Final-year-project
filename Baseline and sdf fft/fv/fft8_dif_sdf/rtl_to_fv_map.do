...
# Generated on: Wed Feb 25 15:43:20 IST 2026 (Wed Feb 25 10:13:20 UTC 2026)
...
set logfile fv/fft8_dif_sdf/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/fft8_dif_sdf -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  fft8_dif_sdf.v
elaborate_design -golden -root {fft8_dif_sdf} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fft8_dif_sdf/fv_map.v.gz
elaborate_design -revised -root {fft8_dif_sdf}
...
#add_name_alias fv/fft8_dif_sdf/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.fft8_dif_sdf.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.fft8_dif_sdf.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.fft8_dif_sdf.rtl.fv_map.rpt
