...
# Generated on: Thu Feb 26 11:18:09 IST 2026 (Thu Feb 26 05:48:09 UTC 2026)
...
set logfile fv/fft8_radix2_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/fft8_radix2_top -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  fft8_radix2_top.v stage1_radix2.v stage2_radix2_block_sdf.v stage3_radix2_block_sdf.v
elaborate_design -golden -root {fft8_radix2_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fft8_radix2_top/fv_map.v.gz
elaborate_design -revised -root {fft8_radix2_top}
...
#add_name_alias fv/fft8_radix2_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.fft8_radix2_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.fft8_radix2_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.fft8_radix2_top.rtl.fv_map.rpt
