...
# Generated on: Tue Mar 10 11:02:38 IST 2026 (Tue Mar 10 05:32:38 UTC 2026)
...
set logfile fv/fft8_sdf_csd_andbypass_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/fft8_sdf_csd_andbypass_top -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  stage2_sdf_csd_andbypass.v stage3_sdf_csd_andbypass.v fft8_sdf_csd_andbypass_top.v
elaborate_design -golden -root {fft8_sdf_csd_andbypass_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fft8_sdf_csd_andbypass_top/fv_map.v.gz
elaborate_design -revised -root {fft8_sdf_csd_andbypass_top}
...
#add_name_alias fv/fft8_sdf_csd_andbypass_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
add_black_box stage1_sdf_csd_andbypass -golden
...
set_system_mode lec
write_compared_points noneq.compared_points.fft8_sdf_csd_andbypass_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.fft8_sdf_csd_andbypass_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.fft8_sdf_csd_andbypass_top.rtl.fv_map.rpt
