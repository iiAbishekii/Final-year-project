module fft8_radix2_sdf_stream_top (
    ...
    // -------------------------------------------------------------------------
    // Inter-stage pipeline registers (gating / warmup)
    // -------------------------------------------------------------------------
    ...
    reg [2:0] s1_warmup_cnt;   // skip first 4 Stage-1 outputs
    reg [1:0] s2_warmup_cnt;   // skip first 2 Stage-2 outputs
    ...
    // =========================================================================
    // STAGE 1  -  delay = 4, no twiddle multiplication
    // =========================================================================
    ...
    // -------------------------------------------------------------------------
    // Stage-1 ? Stage-2 gating  (discard first 4 outputs = warmup)
    // -------------------------------------------------------------------------
    ...
    // =========================================================================
    // STAGE 2  -  delay = 2, twiddles W^0=1 and W^2=-j (trivial)
    // =========================================================================
    ...
    // -------------------------------------------------------------------------
    // Stage-2 ? Stage-3 gating  (discard first 2 outputs = warmup)
    // -------------------------------------------------------------------------
    always @(posedge clk) begin
        s23_valid <= 0;
        if (s2_valid) begin
    ...
    // =========================================================================
    // STAGE 3  -  delay = 1, twiddles W^0..W^3
    //             W^1 and W^3 implemented with Vedic 16x16 signed multiplier
    //             using Q1.15 fixed-point encoding of 1/sqrt(2)
    // =========================================================================
