...
# Generated on: Thu Mar 05 11:36:16 IST 2026 (Thu Mar 05 06:06:16 UTC 2026)
...
set logfile fv/fft8_radix2_sdf_stream_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/fft8_radix2_sdf_stream_top -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  vedic_2x2.v vedic_4x4.v vedic_8x8.v vedic_16x16_unsigned.v vedic_16x16_signed.v stage1_radix2_sdf.v stage2_radix2_sdf_stream.v stage3_radix2_sdf_stream.v fft8_radix2_sdf_stream_top.v
elaborate_design -golden -root {fft8_radix2_sdf_stream_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fft8_radix2_sdf_stream_top/fv_map.v.gz
elaborate_design -revised -root {fft8_radix2_sdf_stream_top}
...
#add_name_alias fv/fft8_radix2_sdf_stream_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.fft8_radix2_sdf_stream_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.fft8_radix2_sdf_stream_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.fft8_radix2_sdf_stream_top.rtl.fv_map.rpt
